...
this.options.enableFilters&&a.find('input[type="text"]').on("keyup",b.proxy(this._filterHandler,this)).end().show();return c},_buildControls:function(){this.controls=b("<div></div>").addClass(this.options.controlsContainerClass);this.addAllButton=b('<button class="btn btn-small"></button>').on("click",b.proxy(this._addAllHandler,this)).html(this.options.addAllLabel).addClass(this.options.addAllClass);this.addButton=b('<button class="btn btn-small"></button>').on("click",b.proxy(this._addHandler,this)).html(this.options.addLabel).addClass(this.options.addClass);
this.removeButton=b('<button class="btn btn-small"></button>').on("click",b.proxy(this._removeHandler,this)).html(this.options.removeLabel).addClass(this.options.removeClass);this.removeAllButton=b('<button class="btn btn-small"></button>').on("click",b.proxy(this._removeAllHandler,this)).html(this.options.removeAllLabel).addClass(this.options.removeAllClass);this.controls.append(this.addAllButton).append(this.addButton).append(this.removeButton).append(this.removeAllButton);return this.controls},_populateLists:function(){var a=
